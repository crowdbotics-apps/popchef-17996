"""popchef_17996 URL Configuration
...
admin.site.site_header = "PopChef"
admin.site.site_title = "PopChef Admin Portal"
admin.site.index_title = "PopChef Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="PopChef API",
        default_version="v1",
        description="API documentation for PopChef App",
    ),
    public=True,
